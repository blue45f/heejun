import { n as e, r as t, t as n } from './index-CYjIRUyQ.js'
var r = e((e, t) => {
    var n = function (e) {
  ...
  x = e((e, t) => {
    ...
    ;(c && ((l = c.split(`.`)), (u = l[0] > 0 && l[0] < 4 ? 1 : +(l[0] + l[1]))),
      !u &&
        i &&
        ((l = i.match(/Edge\/(\d+)/)),
        (!l || l[1] >= 74) && ((l = i.match(/Chrome\/(\d+)/)), l && (u = +l[1]))),
      (t.exports = u))
  }),
  S = e((e, t) => {
    var n = x(),
      ...
      ? r
        ? function (e, t, n) {
            if (
              ...
              (t = o(t)),
              i(n),
              typeof e == `function` && t === `prototype` && `value` in n && f in n && !n[f])
            ) {
              var r = l(e, t)
              r &&
                r[f] &&
  ...
  de = e((e, t) => {
    var n = u(),
      ...
      C = (t.exports = function (e, t, n) {
        ;(v(h(t), 0, 7) === `Symbol(` && (t = `[` + y(h(t), /^Symbol\(([^)]*)\).*$/, `$1`) + `]`),
          n && n.getter && (t = `get ` + t),
          n && n.setter && (t = `set ` + t),
          (!s(e, `name`) || (l && e.name !== t)) &&
            (c ? _(e, `name`, { value: t, configurable: !0 }) : (e.name = t)),
          x && n && s(n, `arity`) && e.length !== n.arity && _(e, `length`, { value: n.arity }))
        try {
  ...
  je = e((e, t) => {
    ...
    t.exports = function (e, t, a) {
      ;(e && !a && (e = e.prototype), e && !r(e, i) && n(e, i, { configurable: !0, value: t }))
    }
  }),
  Me = e((e, t) => {
    var n = de(),
    ...
    ;((!_ || !v) &&
      ...
      h
        ...
        : b && b.now
          ...
          : S && !m
            ? ((k = new S()), (A = k.port2), (k.port1.onmessage = N), (O = o(A.postMessage, A)))
            : n.addEventListener &&
                s(n.postMessage) &&
                !n.importScripts &&
                D &&
  ...
  rt = e(() => {
    var e = U(),
      ...
      re = O.f,
      z = re,
      ie = !!(te && te.createEvent && i.dispatchEvent),
      ae = `unhandledrejection`,
      oe = `rejectionhandled`,
      se = 0,
      ce = 1,
      le = 2,
      ...
      _e = function (e, t) {
        ...
        try {
          i
            ? (r || (t.rejection === de && xe(t), (t.rejection = B)),
              i === !0 ? (l = n) : (c && c.enter(), (l = i(n)), c && (c.exit(), (d = !0))),
              l === e.promise
                ? s(new ee(`Promise-chain cycle`))
                : (u = ge(l))
                  ? o(u, l, a, s)
                  : a(l))
            : s(n)
    ...
    ;((a[p] = !0),
      (t.exports =
        ...
        function (e, t) {
          var i
          return (
            e === null ? (i = y()) : ((m[d] = n(e)), (i = new m()), (m[d] = null), (i[p] = e)),
            t === void 0 ? i : r.f(i, t)
          )
        }))
  }),
...
` &&
        ...
        return function (t, n) {
          ...
          return u < 0 || u >= d
            ? e
              ...
              : void 0
            : ((f = s(l, u)),
              f < 55296 || f > 56319 || u + 1 === d || (p = s(l, u + 1)) < 56320 || p > 57343
                ? e
                  ? o(l, u)
                  : f
                : e
        ...
        return [
          ...
          function (t, n) {
            ...
            for (var D = ``, M = 0, N = 0; N < y.length; N++) {
              C = y[N]
              for (
                var P = p(C[0]), F = w(T(d(C.index), l.length), 0), I = [], L, R = 1;
                R < C.length;
                R++
              )
                O(I, j(C[R]))
  ...
  Kt = e((e, t) => {
    ...
    ;([].keys &&
      ((h = [].keys()),
      `next` in h ? ((m = s(s(h))), m !== Object.prototype && (p = m)) : (f = !0)),
      !a(p) ||
      n(function () {
        var e = {}
        return p[d].call(e) !== e
...
var rn = e((e, t) => {
  ...
  on = e(() => {
    var e = U(),
      ...
      r = x()
    e(
      { target: `Array`, proto: !0, forced: (!Te() && r > 79 && r < 83) || !n(`reduce`) },
      {
        reduce: function (e) {
        ...
        return [
          ...
          function (e, t) {
            ...
            for (var E = 0, D = 0, k = []; D < o.length; ) {
              ...
              var A = g(v, b ? w(o, D) : o),
                j
              if (A === null || (j = S(d(v.lastIndex + (b ? D : 0)), o.length)) === E)
                D = l(o, D, _)
              else {
  ...
  un = e((e, t) => {
    for (
      ...
      ((o = r[i[c] + `Request` + a]), (s = r[i[c] + `Cancel` + a] || r[i[c] + `CancelRequest` + a]))
    if (!o || !s) {
      var l = 0,
        u = 0,
        d = [],
      ...
      ;((this.r = this.r < 0 || isNaN(this.r) ? 0 : this.r > 255 ? 255 : this.r),
        ...
        (this.getHelpXML = function () {
          for (var e = [], r = 0; r < n.length; r++)
            for (var i = n[r].example, a = 0; a < i.length; a++) e[e.length] = i[a]
...
function wn(e) {
  ...
  for (var n = 0; n < e.length; n++) {
    ...
    if (r.type === K.CLOSE_PATH) t += `z`
      ...
      if (r.type !== K.ARC)
        throw Error(`Unexpected command type "` + r.type + `" at index ` + n + `.`)
      t +=
        (r.relative ? `a` : `A`) +
        r.rX +
        ` ` +
...
function En() {
  for (var e = [...arguments], t = 0; t < e.length; t++)
    if (typeof e[t] != `number`)
      throw Error(
        `assertNumbers arguments[` + t + `] is not a number. ` + typeof e[t] + ` == typeof ` + e[t],
      )
  return !0
}
var Dn = Math.PI
function On(e, t, n) {
  ...
  var d = r ** 2 * l ** 2 + i ** 2 * c ** 2,
    f = (e.lArcFlag === e.sweepFlag ? -1 : 1) * Math.sqrt(Math.max(0, (r ** 2 * i ** 2 - d) / d)),
    p = ((r * l) / i) * f,
    m = ((-i * c) / r) * f,
  ...
  function n() {
    ...
    return i(function (i, a, o) {
      return (
        ...
        i.type & K.CURVE_TO
          ? ((e = i.relative ? a + i.x2 : i.x2), (t = i.relative ? o + i.y2 : i.y2))
          : ((e = NaN), (t = NaN)),
        ...
        i.type & K.QUAD_TO
          ? ((n = i.relative ? a + i.x1 : i.x1), (r = i.relative ? o + i.y1 : i.y1))
          : ((n = NaN), (r = NaN)),
        i
      )
    })
  ...
  function a(e, t, n, r, a, o) {
    return (
      ...
      i(function (i, s, c, l) {
        ...
        ;(i.type & K.HORIZ_LINE_TO && t !== 0 && ((i.type = K.LINE_TO), (i.y = i.relative ? 0 : c)),
          i.type & K.VERT_LINE_TO && n !== 0 && ((i.type = K.LINE_TO), (i.x = i.relative ? 0 : s)),
    ...
    (e.NORMALIZE_HVZ = function (e, t, n) {
      return (
        ...
        i(function (r, i, a, o, s) {
          ...
          return (
            t && r.type & K.HORIZ_LINE_TO && ((r.type = K.LINE_TO), (r.y = r.relative ? 0 : a)),
            n && r.type & K.VERT_LINE_TO && ((r.type = K.LINE_TO), (r.x = r.relative ? 0 : i)),
            e &&
              r.type & K.CLOSE_PATH &&
              ((r.type = K.LINE_TO),
    ...
    (e.SANITIZE = function (e) {
      ...
      return i(function (i, o, s, c, l) {
        var u = Math.abs,
          ...
          p = 0
        if (
          (i.type & K.SMOOTH_CURVE_TO && ((f = isNaN(t) ? 0 : o - t), (p = isNaN(n) ? 0 : s - n)),
          i.type & (K.CURVE_TO | K.SMOOTH_CURVE_TO)
            ? ((t = i.relative ? o + i.x2 : i.x2), (n = i.relative ? s + i.y2 : i.y2))
            : ((t = NaN), (n = NaN)),
          i.type & K.SMOOTH_QUAD_TO
            ? ((r = isNaN(r) ? o : 2 * o - r), (a = isNaN(a) ? s : 2 * s - a))
            : i.type & K.QUAD_TO
              ? ((r = i.relative ? o + i.x1 : i.x1), (a = i.relative ? s + i.y1 : i.y2))
              : ((r = NaN), (a = NaN)),
          ...
          ;((f = isNaN(r) ? (i.x1 === void 0 ? f : i.relative ? i.x : i.x1 - o) : r - o),
            (p = isNaN(a) ? (i.y1 === void 0 ? p : i.relative ? i.y : i.y1 - s) : a - s))
                  ...
                  if (this.curNumber && this.curCommandType !== -1) {
                    ...
                    if (this.curCommandType === K.ARC) {
                      if (this.curArgs.length === 0 || this.curArgs.length === 1) {
                        if (0 > c)
                          throw SyntaxError(
                            `Expected positive number, got "` + c + `" at index "` + i + `"`,
                          )
                      } else if (
                        (this.curArgs.length === 3 || this.curArgs.length === 4) &&
                        this.curNumber !== `0` &&
                    ...
                    ;(this.curArgs.push(c),
                      this.curArgs.length === Bn[this.curCommandType] &&
                        (K.HORIZ_LINE_TO === this.curCommandType
                          ? r({ type: K.HORIZ_LINE_TO, relative: this.curCommandRelative, x: c })
                          : K.VERT_LINE_TO === this.curCommandType
                            ? r({ type: K.VERT_LINE_TO, relative: this.curCommandRelative, y: c })
...
function Gn(e, t, n, r, i) {
  if (
    ...
    throw TypeError('Expecting canvas with `getContext` method in processCanvasRGB(A) calls!')
...
function qn(e, t, n, r, i, a) {
  ...
  for (var g = null, _ = null, v = 0, y = 0, b = Un[a], x = Wn[a], S = 0; S < i; S++) {
    p = f
    for (var C = o[y], w = o[y + 1], T = o[y + 2], E = o[y + 3], D = 0; D < u; D++)
...
function Yn() {
  var { DOMParser: e } = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {},
    t = {
      window: null,
      ignoreAnimation: !0,
      ignoreMouse: !0,
...
function q(e) {
  return ((e || ``).match(/-?(\d+(?:\.\d*(?:[eE][+-]?\d+)?)?|\.\d+)(?=\D|$)/gm) || []).map(
    parseFloat,
  )
}
var tr = /^[A-Z-]+$/
    ...
    if (typeof n.createPattern == `function`) {
      if (n.getHrefAttribute().hasValue()) {
        ...
        ;((n = n.getHrefAttribute().getDefinition()),
          r.hasValue() && n.getAttribute(`patternTransform`, !0).setValue(r.value))
      }
...
var Tr = class {
  ...
  Er = class {
    ...
    mapXY(e, t) {
      for (var { window: n, ctx: r } = this.screen, i = new Y(e, t), a = r.canvas; a; )
  ...
  kr = class {
        ...
        var m = Date.now(),
          ...
          _ = () => {
            ;((m = Date.now()),
              ...
              g >= p &&
                ((h = m - (g % p)),
                this.shouldUpdate(r, o) && (this.render(e, i, a, s, c, l, u), f.runEvents())),
    ...
    render(e, t, n, r, i, a, o) {
      var { CLIENT_WIDTH: s, CLIENT_HEIGHT: c, viewPort: l, ctx: u, isFirstRender: d } = this,
        f = u.canvas
      ...
      !t &&
        ...
        (p.hasValue() &&
          ((f.width = p.getPixels(`x`)), f.style && (f.style.width = `${f.width}px`)),
        m.hasValue() &&
          ((f.height = m.getPixels(`y`)), f.style && (f.style.height = `${f.height}px`)))
      var h = f.clientWidth || f.width,
        g = f.clientHeight || f.height
      if (
        (t && p.hasValue() && m.hasValue() && ((h = p.getPixels(`x`)), (g = m.getPixels(`y`))),
        l.setCurrent(h, g),
  ...
  Pr = class {
    ...
    applyToPoint(e) {
      var { cx: t, cy: n, angle: r } = this,
        i = r.getRadians()
      ;(e.applyTransform([1, 0, 0, 1, t || 0, n || 0]),
        e.applyTransform([Math.cos(i), Math.sin(i), -Math.sin(i), Math.cos(i), 0, 0]),
        e.applyTransform([1, 0, 0, 1, -t || 0, -n || 0]))
    }
  },
  Fr = class {
  ...
  Ir = class {
    ...
    unapply(e) {
      var { originX: t, originY: n, matrix: r } = this,
        ...
        d = 0,
        f = 1,
        p = 1 / (i * (c * f - l * d) - a * (s * f - l * u) + o * (s * d - c * u)),
        m = t.getPixels(`x`),
        h = n.getPixels(`y`)
      ;(e.translate(m, h),
        e.transform(
...
Hr.transformTypes = { translate: Nr, rotate: Pr, scale: Fr, matrix: Ir, skewX: Rr, skewY: zr }
var X = class e {
  constructor(e, t) {
      ...
      if (!n.startsWith(`@`) && this.matchesSelector(n)) {
        ...
        if (r)
          for (var a in r) {
            ...
            ;(o === void 0 && (o = `000`),
              i >= o && ((this.styles[a] = r[a]), (this.stylesSpecificity[a] = i)))
          }
      }
  }
  removeStyles(e, t) {
...
var Yr = class {
    constructor() {
      var e = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : NaN,
        t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : NaN,
        n = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : NaN,
        r = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : NaN
      ;((this.x1 = e),
        (this.y1 = t),
        (this.x2 = n),
        (this.y2 = r),
    ...
    bezierCurveAdd(e, t, n, r, i) {
      ...
      if (o === 0) {
        ...
        0 < c &&
          c < 1 &&
          (e ? this.addX(this.sumCubic(c, t, n, r, i)) : this.addY(this.sumCubic(c, t, n, r, i)))
        return
      }
      var l = a ** 2 - 4 * s * o
      if (!(l < 0)) {
        ...
        0 < u &&
          u < 1 &&
          (e ? this.addX(this.sumCubic(u, t, n, r, i)) : this.addY(this.sumCubic(u, t, n, r, i)))
        var d = (-a - Math.sqrt(l)) / (2 * o)
        0 < d &&
          d < 1 &&
          (e ? this.addX(this.sumCubic(d, t, n, r, i)) : this.addY(this.sumCubic(d, t, n, r, i)))
      }
    }
  ...
  Z = class extends K {
    ...
    getReflectedControlPoint() {
      ...
      if (e !== K.CURVE_TO && e !== K.SMOOTH_CURVE_TO && e !== K.QUAD_TO && e !== K.SMOOTH_QUAD_TO)
        return this.current
      var {
        current: { x: t, y: n },
        control: { x: r, y: i },
    ...
    addMarker(e, t, n) {
      ...
      ;(n && i.length > 0 && !i[i.length - 1] && (i[i.length - 1] = r[r.length - 1].angleTo(n)),
  ...
  Xr = class extends X {
    ...
    setContext(e) {
      ...
      if (!t) {
        ...
        if (
          (r.hasValue() &&
            (e.fillStyle = new J(this.document, `fill`, e.fillStyle).addOpacity(r).getColor()),
          i.isUrlDefinition())
        ) {
        ...
        a.hasValue() &&
          (e.strokeStyle = new J(this.document, `stroke`, e.strokeStyle).addOpacity(a).getString())
        ...
        if (
          ...
          e.setLineDash === void 0
            ? e.webkitLineDash === void 0
              ? e.mozDash !== void 0 && !(g.length === 1 && g[0] === 0) && (e.mozDash = g)
              : (e.webkitLineDash = g)
            : e.setLineDash(g)
          var _ = h.getPixels()
      ...
      if (((this.modifiedEmSizeStack = !1), e.font !== void 0)) {
        ...
        ;(y.setValue(w.fontStyle),
          ...
          (e.font = w.toString()),
          S.isPixels() && ((this.document.emSize = S.getPixels()), (this.modifiedEmSizeStack = !0)))
      }
  ...
  Q = class e extends Xr {
    ...
    renderChildren(e) {
      ...
      ;(e.fillStyle !== `` &&
        (t.getString(`inherit`) === `inherit` ? e.fill() : e.fill(t.getString())),
        e.strokeStyle !== `` &&
    ...
    static pathT(e) {
      ...
      return ((e.control = n), { current: t, controlPoint: n, currentPoint: e.getAsCurrentPoint() })
    }
    pathT(t, n) {
      var { pathParser: r } = this,
    ...
    static pathA(e) {
      ...
      return (
        gr(g, _) <= -1 && (v = Math.PI),
        gr(g, _) >= 1 && (v = 0),
        { currentPoint: l, rX: r, rY: i, sweepFlag: s, xAxisRotation: c, centp: m, a1: h, ad: v }
      )
    }
    pathA(t, n) {
      var { pathParser: r } = this,
  ...
  Qr = class e extends Xr {
    ...
    adjustChildCoordinates(e, t, n, r) {
      ...
      return (
        ...
        u || (t.x += d),
        o.hasValue()
          ? ((i.y = o.getPixels(`y`)), c.hasValue() && (i.y += c.getPixels(`y`)))
  ...
  ti = class extends Xr {
    ...
    setContext(e) {
      ...
      var c = this.getAttribute(`refX`),
        ...
        f = !this.root && this.getStyle(`overflow`).getValue(`hidden`) !== `visible`,
        p = 0,
        m = 0,
        h = 0,
        g = 0
      ...
      if (
        ...
        ;(e.beginPath(),
          i > 0 &&
            ...
            (e.moveTo(t + s, n),
            e.lineTo(t + r - s, n),
            e.bezierCurveTo(t + r - s + l * s, n, t + r, n + c - l * c, t + r, n + c),
            e.lineTo(t + r, n + i - c),
            e.bezierCurveTo(t + r, n + i - c + l * c, t + r - s + l * s, n + i, t + r - s, n + i),
            e.lineTo(t + s, n + i),
            e.bezierCurveTo(t + s - l * s, n + i, t, n + i - c + l * c, t, n + i - c),
            e.lineTo(t, n + c),
  ...
  ri = class extends Q {
    ...
    path(e) {
      ...
      return (
        e && r > 0 && (e.beginPath(), e.arc(t, n, r, 0, Math.PI * 2, !1), e.closePath()),
  ...
  ci = class extends X {
    ...
    createPattern(e, t, n) {
      ...
      ;(c.hasValue() && l.hasValue() && s.translate(c.getPixels(`x`, !0), l.getPixels(`y`, !0)),
        n.hasValue()
    ...
    render(e, t, n) {
      if (t) {
        ...
        ;((s.type = this.type),
          ...
          (s.attributes.refX = new J(this.document, `refX`, this.getAttribute(`refX`).getValue())),
          (s.attributes.refY = new J(this.document, `refY`, this.getAttribute(`refY`).getValue())),
  ...
  di = class extends Xr {
    ...
    createGradient(e, t, n) {
      ...
      this.getHrefAttribute().hasValue() &&
        ((r = this.getHrefAttribute().getDefinition()), this.inheritStopContainer(r))
      var { stops: i } = r,
  ...
  gi = class extends X {
    ...
    update(e) {
      ...
      if (
        (this.initialValue ||
          ((this.initialValue = n.getString()), (this.initialUnits = n.getUnits())),
        ...
        if (
          ...
          return (
            (this.removed = !0),
            n.setValue(t.animationFrozen ? t.animationFrozenValue : this.initialValue),
            !0
          )
        return !1
      }
        ...
        switch (a.type) {
          ...
          case `glyph`:
            ...
            s.arabicForm
              ? ((this.isRTL = !0),
                (this.isArabic = !0),
                this.glyphs[s.unicode] === void 0 && (this.glyphs[s.unicode] = Object.create(null)),
  ...
  Ci = class extends Qr {
    ...
    renderChildren(e) {
      if (this.hasText) {
        ...
        i.isWorking() &&
          i.checkBoundingBox(this, new Yr(n, r - a.getPixels(`y`), n + this.measureText(e), r))
...
var Ei = class extends Qr {
      ...
      ;(t === `underline` && e.beginPath(),
        r.forEach((r, i) => {
          ...
          ;(e.save(),
            ...
            e.restore(),
            t === `underline` &&
              (i === 0 && e.moveTo(a.x, a.y + n / 8), e.lineTo(o.x, o.y + n / 5)))
        }),
        t === `underline` &&
          ((e.lineWidth = n / 20), (e.strokeStyle = i), e.stroke(), e.closePath()),
        e.restore())
    }
    getLetterSpacingAt() {
      ...
      if (!this.glyphInfo) {
        ...
        ;((o === `middle` || o === `center`) && (v = -h / 2),
          ...
          n.forEach((t, i) => {
            ...
            ;((v = s),
              !(!c.p0 || !c.p1) &&
                this.glyphInfo.push({ text: n[i], p0: c.p0, p1: c.p1, rotation: l }))
          }))
      }
    }
    parsePathData(e) {
    ...
    calcLength(e, t, n, r) {
      ...
      switch (n) {
        ...
        case Z.CURVE_TO:
          for (
            i = 0,
              a = this.getPointOnCubicBezier(0, e, t, r[0], r[1], r[2], r[3], r[4], r[5]),
              s = 0.01;
            s <= 1;
            s += 0.01
          )
            ((o = this.getPointOnCubicBezier(s, e, t, r[0], r[1], r[2], r[3], r[4], r[5])),
              (i += this.getLineLength(a.x, a.y, o.x, o.y)),
              (a = o))
          return i
        case Z.QUAD_TO:
          for (
            i = 0, a = this.getPointOnQuadraticBezier(0, e, t, r[0], r[1], r[2], r[3]), s = 0.01;
            s <= 1;
            s += 0.01
          )
            ((o = this.getPointOnQuadraticBezier(s, e, t, r[0], r[1], r[2], r[3])),
              (i += this.getLineLength(a.x, a.y, o.x, o.y)),
              (a = o))
          return i
        case Z.ARC:
    ...
    getPointOnLine(e, t, n, r, i) {
      var a = arguments.length > 5 && arguments[5] !== void 0 ? arguments[5] : t,
    ...
    getPointOnQuadraticBezier(e, t, n, r, i, a, o) {
      return { x: a * Sr(e) + r * Cr(e) + t * wr(e), y: o * Sr(e) + i * Cr(e) + n * wr(e) }
    }
      ...
      if (
        ...
        for (var a = 0, o = 0; o <= n; o += r) {
          ...
          !s ||
            ...
            a >= i &&
              (this.equidistantCache.points.push({ x: s.x, y: s.y, distance: o }), (a -= i)))
        }
      }
    }
  ...
  renderChildren(e) {
    ...
    if (n) {
      ...
      if (
        (n.type === `symbol` &&
          ((r = new ti(t, null)),
          (r.attributes.viewBox = new J(t, `viewBox`, n.getAttribute(`viewBox`).getString())),
          (r.attributes.preserveAspectRatio = new J(
            t,
            `preserveAspectRatio`,
            n.getAttribute(`preserveAspectRatio`).getString(),
          )),
          (r.attributes.overflow = new J(t, `overflow`, n.getAttribute(`overflow`).getString())),
        ...
        ;(i.hasValue() && (r.attributes.width = new J(t, `width`, i.getString())),
          a.hasValue() && (r.attributes.height = new J(t, `height`, a.getString())))
      }
      var o = r.parent
...
var Ii = class extends X {
    ...
    apply(e, t, n, r, i) {
      for (
        var { includeOpacity: a, matrix: o } = this, s = e.getImageData(0, 0, r, i), c = 0;
        c < i;
        c++
      )
        for (var l = 0; l < r; l++) {
          var u = Ni(s.data, l, c, r, i, 0),
            ...
            g = $(o, 10, u) + $(o, 11, d) + $(o, 12, f) + $(o, 13, p) + $(o, 14, 1),
            _ = $(o, 15, u) + $(o, 16, d) + $(o, 17, f) + $(o, 18, p) + $(o, 19, 1)
...
var na = class e {
  ...
  render() {
    ...
    return yt(function* () {
      ...
      ;(t.start(ta({ enableRedraw: !0, ignoreAnimation: !0, ignoreMouse: !0 }, n)),
        yield t.ready(),
        t.stop())
    })()
  }
