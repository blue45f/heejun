  ...
  experiences: [
    {
      ...
      achievements: [],
      techStack: '',
      note: '모친 대수술 후 갑작스러운 건강 악화로 간병을 위해 부득이하게 조기 퇴사. 현재는 건강이 회복되어 다시 구직 활동 중이며, 그동안 1인 개발·프리랜서로 활동',
    },
    {
  ...
  personalProjects: [
    ...
    },
    {
      ...
      bullets: [
        ...
        '완수했습니다.',
        '토스 앱인토스 정식 출시(2026-06-29): @apps-in-toss/web-framework(v3) 기반 미니앱을',
        '별도 apps/toss 패키지로 빌드해 토스 앱 생태계에 출시했습니다. 웹 페이지·공유 로직을 그대로',
        '재사용하는 얇은 셸 구조에 TDS 디자인 시스템, appLogin→서버 mTLS 토큰 교환 로그인, 인앱',
        '배너 광고, 핵심 지표(리텐션·전환)를 연동했고 MediaPipe 얼굴 트래킹 스튜디오까지 인앱에서',
        '제공합니다. (토스 앱 딥링크: intoss://toonspectrum)',
      ],
      techStack:
        'TypeScript 6, React 19, Vite 8, Tailwind CSS 4, Zustand 5, TanStack Query 5, Three.js (R3F), VRM/MediaPipe, Motion 12, Socket.IO, NestJS 11, Drizzle ORM, Neon PostgreSQL, Zod 4, React Compiler, Toss 미니앱(앱인토스)',
    ...
    },
    {
      ...
      bullets: [
        ...
        '토스 앱인토스 정식 출시(2026-07-01): @apps-in-toss/web-framework(v3) 기반 미니앱을',
        '별도 apps/toss 패키지로 빌드해 토스 앱에 출시했습니다. 웹 콘텐츠·커뮤니티를 재사용하는 얇은',
        '셸 구조에 TDS 디자인, appLogin→서버 mTLS 로그인, 인앱 배너·보상형 광고, 핵심 지표를',
        '연동했습니다. (토스 앱 딥링크: intoss://aidigestdesk)',
      ],
      techStack:
        'TypeScript, React 19, Vite 8, Tailwind CSS 4, Zustand 5, Recharts, Framer Motion, tsup, Playwright, Turborepo, Toss 미니앱(앱인토스)',
      infraConfig: 'Vercel (production) + GitHub Pages (보조 정적 배포)',
      publishInfo: '',
      links: [
        { href: 'https://aidigestdesk.vercel.app', text: 'Live Demo' },
        { href: 'intoss://aidigestdesk', text: 'Toss 미니앱' },
    ...
    },
    {
      ...
      bullets: [
        ...
        '슈퍼앱 연동 및 정식 출시(2026-06-26): @apps-in-toss/web-framework(v3) 기반 토스',
        '미니앱을 별도 apps/toss 패키지로 개발해 토스 앱 심사를 통과·출시했습니다. TDS 디자인,',
        'appLogin→서버 mTLS 로그인, 인앱 배너 광고, 핵심 지표를 연동해 토스 생태계 내 투표 공유를',
        '지원합니다. (토스 앱 딥링크: intoss://picky)',
      ],
      techStack:
        'TypeScript, React 19, Vite 8, Radix UI, Zustand 5, NestJS 11, Drizzle ORM, Neon PostgreSQL, Vercel Blob, Vercel KV, JWT, Toss 미니앱(앱인토스)',
      infraConfig: 'Vercel Serverless (API + Frontend) + Neon PostgreSQL',
      publishInfo: '',
      links: [
        { href: 'https://picky-olive.vercel.app', text: 'Live Demo' },
        { href: 'intoss://picky', text: 'Toss 미니앱' },
