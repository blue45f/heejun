...
2. [Module Federation 2.x vs Native Federation 비교](#2-module-federation-2x-vs-native-federation-비교)
3. [Single-SPA vs Module Federation vs iframe 비교](#3-single-spa-vs-module-federation-vs-iframe-비교)
4. [Module Federation 2.x 실전 설정](#4-module-federation-2x-실전-설정)
