...
| 날짜 | 버전 | 내용 |
|------|------|------|
| 2025-08-29 | 1.0.0 | 첫 버전 |
| 2025-10-16 | - | "들어가며" 부분의 "초안입니다" 내용 삭제 |
| 2025-11-20 | 1.0.1 | 개인정보 처리방침 개정에 따른 안내 변경 |
...
개인정보는 원칙적으로 로그에 저장할 수 없습니다. 다만, **CS 처리 및 서비스 운영을 위해 고객 식별이 필요한 경우**, 아래 항목은 2025년 11월 7일부터 시행된 개인정보처리방침에 따라 **예외적으로 수집·저장이 가능합니다.**
