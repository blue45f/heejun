# 07. 테스팅 가이드 (2025-2026 Edition)

| 분류 | 품질 & 성능 | 상태 | Stable |
| :--- | :--- | :--- | :--- |
| **연관 가이드** | [04. 아키텍처](./04_아키텍처_설계_패턴.md), [10. 인프라](./10_인프라_및_AWS_CDK_가이드.md), [11. CI/CD](./11_CICD_파이프라인_표준.md) | **AI 도구** | Vitest, Playwright, Claude Code |
| **핵심 테마** | AI 테스트 생성, 가상 응답(MSW), E2E 최적화, 뮤테이션 테스팅, 커버리지 전략 | **Update** | 2025.04 |
...
| 종류 | 패턴 | 예시 |
| :--- | :--- | :--- |
| 단위 테스트 | `*.test.ts(x)` | `useAuth.test.ts`, `Button.test.tsx` |
